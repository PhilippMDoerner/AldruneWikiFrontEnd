...
export class CampaignUpdateComponent extends ArticleFormMixin {
  ...
  formlyFields: FormlyFieldConfig[] = [
    ...
    this.formlyService.genericSelect({key: "default_map", label: "Default Map", valueProp: "pk", overviewType: OverviewType.Map, campaign: this.campaign.name, required: false}),
